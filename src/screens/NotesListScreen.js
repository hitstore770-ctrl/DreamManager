  ...
  return (
    <View style={[s.screen, { paddingTop: insets.top }]}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <Text style={s.empty}>
            {query || activeTag ? "No notes match." : "No notes yet. Tap + to write one."}
          </Text>
        }
      />
...
const styles = (t) =>
  StyleSheet.create({
    ...
    searchWrap: { flexDirection: "row", alignItems: "center", marginHorizontal: 14, marginBottom: 10, backgroundColor: t.surfaceAlt, borderRadius: 12, paddingHorizontal: 12, height: 42 },
    searchInput: { flex: 1, color: t.text, fontSize: 15 },
    filterRow: { flexDirection: "row", alignItems: "center", gap: 8, marginHorizontal: 18, marginBottom: 8 },
