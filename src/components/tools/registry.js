...
import { DormSplitter, TillCounter, VatDiscount } from "./apps/finance";
import { JsonValidator, QrGenerator, RnUiGenerator, UuidGenerator } from "./apps/dev";
import { DecisionPicker, PercentDiff, PomodoroTimer, TextAnalyzer } from "./apps/utils";
import { PromptBuilder } from "./apps/prompts";
import { SlowMoFps, VideoSizeEstimator } from "./apps/video";
import { TransitLoadCalc, VendingRoi } from "./apps/vending";
import { ZmanimRoutine } from "./apps/school";
