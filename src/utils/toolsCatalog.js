...
export const TOOL_CATEGORIES = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: "base64", name: "ממיר Base64", icon: "hash" },
      { id: "uuid-gen", name: "מחולל UUID", icon: "key" },
      { id: "hex-color", name: "ממיר RGB ל-HEX", icon: "droplet" },
      ...
      { id: "contrast-check", name: "ניגודיות צבעים", icon: "eye" },
      { id: "icon-sizes", name: "מידות אייקונים", icon: "smartphone" },
      { id: "golden-ratio", name: "יחס הפז לעיצוב", icon: "layout" },
    ],
  },
  {
    key: "video",
  ...
  },
  {
    ...
    tools: [
      ...
      { id: "storage-conv", name: "ממיר נפח דיגיטלי", icon: "hard-drive" },
